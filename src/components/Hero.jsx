...
export default function Hero() {
  ...
  // Add more roles so the rotation actually feels like a rotation,
  // not a 2-way flicker. Edit freely to match your real focus areas.
  const roles = [
    "Software Engineer",
  ...
  // Recreated on every render is wasteful for a static list — memoize it.
  ...
  return (
    ...
    >
      {/* Decorative Animated Background — hidden from assistive tech */}
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left" data-aos="fade-right">
            ...
            {/* Animated Roles Text — visual only; not announced repeatedly */}
          ...
          <div className="relative" data-aos="fade-left" data-aos-delay="200">
            <div className="relative mx-auto lg:mx-0 max-w-md">
              {/* Background Glow */}
              <div
                className="absolute -inset-4 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-3xl blur-xl opacity-20 group-hover:opacity-30 transition duration-1000 group-hover:duration-200 animate-pulse"
                aria-hidden="true"
              ></div>
              ...
              <div className="relative group">
                <div
                  className="absolute -inset-1 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-3xl blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-pulse"
                  aria-hidden="true"
                ></div>
