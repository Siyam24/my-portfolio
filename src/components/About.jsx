...
export default function About() {
  const skills = [
    {
      ...
      description: "React, Flask, Spring Boot",
    },
    {
    ...
    },
    {
      ...
      name: "System Design",
      description: "Scalable & Secure Architecture",
    },
    {
  ...
  return (
    <section
      id="about"
      className="py-20 bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-white transition-colors duration-500"
    >
      {" "}
          ...
          <div className="space-y-6" data-aos="fade-right">
            ...
            <div>
              ...
              <p className="text-xl leading-relaxed text-gray-700 dark:text-gray-300 mb-6">
                ...
                , passionate about crafting innovative digital solutions that
                make a real impact.{" "}
              </p>{" "}
              <p className="text-lg leading-relaxed text-gray-600 dark:text-gray-400 mb-6">
                ...
                specialize in building dynamic, scalable applications using
                modern technologies like{" "}
                <strong className="text-gray-800 dark:text-gray-200">
                  {" "}
                  React, Flask, Java Spring Boot, and MySQL{" "}
                </strong>{" "}
                .{" "}
              </p>{" "}
              <p className="text-lg leading-relaxed text-gray-600 dark:text-gray-400">
                {" "}
                My experience includes developing data-driven systems like sales
                forecasting platforms and comprehensive management software. I
                thrive in{" "}
                <strong className="text-gray-800 dark:text-gray-200">
                  {" "}
                  Agile environments{" "}
                </strong>{" "}
                , enjoy tackling complex challenges, and am committed to
